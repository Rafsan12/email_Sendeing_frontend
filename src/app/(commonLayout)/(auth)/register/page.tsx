  ...
  return (
    <div className="w-full min-h-screen lg:grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-stone-950 p-12 text-stone-100 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-orange-900/20 to-transparent pointer-events-none" />
        <div
      ...
      <div className="flex items-center justify-center bg-[#FFFBF5] p-8 md:p-12 relative">
        ...
        <div className="mx-auto w-full max-w-[400px] space-y-8">
          ...
          <div className="bg-white border border-stone-200 p-1 rounded-2xl shadow-sm">
            <RegisterForm />
          </div>
